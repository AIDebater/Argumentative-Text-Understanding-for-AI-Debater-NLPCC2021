...
def main(config_file='config.json'):
    ...
    valid_set = CMVDataset(path=config['valid_file'], mode='train', tokenizer=tokenizer)
    valid_loader = DataLoader(dataset=valid_set, batch_size=10, shuffle=True, collate_fn=create_mini_batch)
